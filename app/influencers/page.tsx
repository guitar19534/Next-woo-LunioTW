...
const CELEBRITIES: { title: string; desc: string; img: string; videoId: string }[] = [
  { title: "有了Signature床墊，維恩不用跟老公分房睡了",            desc: "Signature床墊可各自調整軟硬度，夫妻再也不用為了床墊喜好分房睡啦！",             img: `${VT}/Cover-VDO-Signature_06.jpg`,        videoId: "kJag4iM7NDU" },
  { title: "誰才是真正的陳晨威？揭開打擊之神的秘密武器",            desc: "運動閃到腰？Quantum Max的完美支撐，讓運動量大的陳晨威遠離疲勞酸痛",          img: `${VT}/Cover-VDO-QTM_02.jpg`,             videoId: "z1QQhmNmm-0" },
  { title: "嚴正嵐找到新室友啦，好眠神器驚喜來臨！",               desc: "室友帶來好眠神器Gen4床墊，改善睡眠，讓嚴正嵐更有活力迎接新夢想",             img: `${VT}/Lunio-VDO-Cover-June_16-9.jpg`,    videoId: "nWczdvL71uU" },
  { title: "熱愛運動的房思瑜，終於挑到放鬆緊繃肌肉的床墊",          desc: "喜歡Quantum Max的6大理由，讓房思瑜每天都期待回家睡覺",                       img: `${VT}/qtm-vdo.jpg`,                      videoId: "Zw6XsnsuMmA" },
  { title: "教練康哥的魔鬼測試！Gen4 床墊能通過嗎？",              desc: "廢宗康率領啦啦隊，對Gen4乳膠床墊進行一連串魔鬼測試，來看Gen4的表現如何",       img: `${VT}/影片封面-庹宗康.webp`,              videoId: "PBGiidEkf1k" },
  { title: "張立東獨家揭開7大秘密！Lunio Gen4 一夜好眠的秘密武器",  desc: "專為提升睡眠品質而研發的助眠神器，涼感、耐重、全身放鬆，Gen4床墊怎麼做到的？", img: `${VT}/Cover-VDO-Gen4.jpg`,               videoId: "LHqCS4Xgd7c" },
  { title: "美女主播蔡尚樺的願望，回家就像睡在5星級飯店一樣",        desc: "什麼？不到5千元，就能享受5星級飯店睡感！Nooz Helix乳膠獨立筒床墊太好睡了",   img: `${VT}/影片封面-蔡尚樺.webp`,             videoId: "TuV1TUZOQig" },
  { title: "浩子阿翔來Lunio踢館拉，準備迎接我們最刺激的時刻！",      desc: "實測看完就知道要買哪張床墊了，Lunio GEN3 Pro乳膠床好睡又能絲滑緩壓痛",      img: `${VT}/影片封面-浩角翔起.webp`,            videoId: "cg8QcoqbzYM" },
  { title: "許孟哲夫妻的家族挑戰，讓人忘記腰痛的Lunio乳膠床墊",      desc: "孟孟家族貫穿一堂，體驗Lunio乳膠床墊的舒適魔力！媽媽腰背全消，小寶貝也睡得著甜", img: `${VT}/影片封面-許孟哲.webp`,           videoId: "qkBjI4w29x8" },
  { title: "台灣孔留小梁哥認證超好睡，Lunio Gen3石墨烯乳膠床墊",     desc: "睡眠真的好重要！只要睡得好整個人沒煩惱，來找Lunio幫全家大小挑一張好的床墊",   img: `${VT}/影片封面-小梁哥.webp`,             videoId: "uLPbN7nK894" },
  { title: "搖浪奶爸柯有倫偷挑中的，GEN3石墨烯乳膠床墊",            desc: "柯有倫為自己及他的寶貝女兒挑選了Lunio GEN3石墨烯乳膠床墊，你在猶豫什麼呢？",   img: `${VT}/影片封面-柯有倫.webp`,             videoId: "sEIURVPfA2A" },
  { title: "微笑殺手潘君侖的充電小角落，一起躺在 Lunio GEN3床上進入夢鄉", desc: "在城市中全力以赴工作的你，是否想要有屬於自己的小角落，盡情放鬆、享受生活", img: `${VT}/影片封面-潘君侖.webp`,          videoId: "0znd6nR6SKAv" },
  { title: "知性氣質吳怡霈確認證！Lunio GEN3超強神床來囉",          desc: "真心推薦睡不好、多夢、長期腰背疼痛，Lunio床墊一定可以拯救你！",              img: `${VT}/影片封面-吳怡霈.webp`,             videoId: "zQK9PWiiR8g" },
  { title: "哈孝遠舒緩腰腹背痛的神隊友！Lunio天然乳膠床",           desc: "哈孝遠心目中最好的床墊！Lunio GEN3讓你的肌肉徹底放鬆",                     img: `${VT}/影片封面-哈孝遠.webp`,             videoId: "_T3ZZTZqvP4" },
  { title: "彩樺姐舒緩腰腹背痛心法，全靠Lunio乳膠床墊",             desc: "有顏有保庇彩樺姐認證「千萬不能錯過」，Lunio床墊是腰背育痛的救星",             img: `${VT}/影片封面-彩樺姐.webp`,             videoId: "psixV7nPuFw" },
  { title: "仁甫季芹相處的秘密法寶！Lunio床墊讓全家人感情更好",      desc: "Lunio乳膠床太好睡，季妹妹與仁甫竟然考慮民宿過後換張床！",                    img: `${VT}/影片封面-仁甫季芹.webp`,           videoId: "CZ566n7lNFk" },
  { title: "亞洲視帝謝祖武，興奮開箱Lunio乳膠床！",                 desc: "選離起床的肩頸腰痛就換這張，床墊層層設計都讓祖武哥讚不絕口！",                 img: `${VT}/影片封面-謝祖武.webp`,             videoId: "y8UKewCYDlo" },
  { title: "孟哲罷要暖暖！甜鹹愛妳送孟孟Lunio天然乳膠床",           desc: "孟孟產後常睡眠不好，孟哲霸氣下訂Lunio乳膠床送老婆！找回新手媽媽的深層睡眠",   img: `${VT}/Thumbnail-Shortgun_Aug2024.jpg`,   videoId: "y4NJfqSDycE" },
  { title: "小禎愛用床墊大公開！就是Lunio 乳膠床！",                desc: "人的一生有一半的時間都會花在睡眠上面，所以有好床真的很重要",                    img: `${VT}/影片封面-小禎.webp`,               videoId: "Nwlf4xgXNsc" },
  { title: "果凍姐姐楊晨熙，專業俯皮開箱！",                        desc: "小資家庭必入手高CP值床墊，它可以讓你肩頸臂達到放鬆的狀態",                    img: `${VT}/影片封面-楊晨熙.webp`,             videoId: "usWPjWd9T0Q" },
  { title: "型男主持人郭彥鈞，率先開箱體驗Lunio！",                  desc: "Lunio有一個很好的抗震效果，非常適合有小孩的媽媽，不會牽一髮動全家",            img: `${VT}/影片封面-郭彥均.webp`,             videoId: "CsgeVpaVU20" },
];

const YOUTUBERS: { title: string; desc: string; img: string; videoId: string }[] = [
  { title: "Lunio Gen4床墊，幫日本媳婦愛子贏得公婆心",              desc: "送公婆新床墊，支撐力好又能緩解腰背育痛的Lunio Gen4，讓老人家也讚不絕口！",   img: `${VT}/影片封面-aiko愛子.webp`,           videoId: "uM4qFzjvTvk" },
  { title: "愛子實測在Nooz Helix床上放雞蛋，躺上去到底會不會破？",   desc: "雞蛋在Nooz Helix獨立筒床墊，躺上去到底…這個床墊也太厲害了吧～",            img: `${VT}/maxresdefault (1).jpg`,            videoId: "b_Eup5pd4do" },
  { title: "為什麼Nooz Helix乳膠獨立筒床墊，讓4M8ER睡得這麼滿意？", desc: "已經睡了好幾天，真的覺得很讚！床墊睡起來Q彈又包覆，怎麼都很舒服～",          img: `${VT}/影片封面-4M8ER.webp`,              videoId: "iMortkGMMdA" },
  { title: "田以熙換新床墊開箱，給你看Nooz Suset有多厲害",           desc: "好的床墊上天堂！如何選擇適合自己的床墊？居然躺在雞蛋上雞蛋不會破？",          img: `${VT}/影片封面-田以熙.webp`,             videoId: "QsZr5plbVaY" },
  { title: "一樹的腰酸背痛睡不好，靠Lunio床墊來解決",               desc: "床墊凹掉、床太硬、住公寓的人，推薦這款創新材質Lunio Quantum乳膠獨立筒床墊！", img: `${VT}/影片封面-一樹.webp`,               videoId: "fpq2t32QRSM" },
  { title: "避免情侶同居爆發衝突，凡清買了張Lunio床墊",              desc: "淺眠的你常因為枕邊人翻身聲翻來覆去嗎？Lunio帶來專為你打造的吸震床墊",        img: `${VT}/影片封面-凡清.webp`,               videoId: "j-l-5C1dZzU" },
  { title: "大胃王路路LuLu，為了貓主子換新床墊！",                   desc: "遠離跳蚤遠離臭臭，必備抗菌防蟎Lunio乳膠床墊",                               img: `${VT}/影片封面-大胃王lulu.webp`,         videoId: "NehQR-HjpeA" },
  { title: "彼得爸與蘇珊媽，親子Youtuber也入坑！",                   desc: "我們試過Lunio床墊之後，就回不去了，還多買三張給家中長輩",                    img: `${VT}/影片封面-彼得爸與蘇珊媽.webp`,    videoId: "vAT8H83sDyc" },
