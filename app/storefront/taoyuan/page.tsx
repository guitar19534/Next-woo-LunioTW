...
const MAP_EMBED = "https://maps.google.com/maps?q=桃園市桃園區正光路393號1樓&output=embed&z=16&hl=zh-TW";
...
export default function TaoyuanStorePage() {
  return (
    <main style={FONT}>
          ...
          <div className="grid md:grid-cols-2 gap-10 md:gap-16 items-start">
            ...
            <div className="flex flex-col items-center text-center">
              ...
              <div className="relative w-full overflow-hidden rounded-2xl mb-6" style={{ aspectRatio: "4/3", maxWidth: 480 }}>
                <Image src="/storefront/Taoyuan-storefront (1).jpg" alt="Lunio 桃園門市" fill className="object-cover" sizes="(max-width:768px) 100vw, 480px" priority />
              </div>

              <div className="space-y-2 mb-6">
                <p style={{ fontSize: 15, color: NAVY, fontWeight: 500 }}>桃園市桃園區正光路393號1樓</p>
                <p style={{ fontSize: 14, color: "#6b7280" }}>（京澄為樂社區）</p>
                <p className="mt-3" style={{ fontSize: 14, color: "#444" }}>營業時間：每日 11:00 — 20:00</p>
                <a href="tel:+886937968020" className="block hover:underline font-medium" style={{ fontSize: 15, color: BLUE }}>
                  聯絡電話：+886 937 968 020
                </a>
                <a href="https://lin.ee/NVndAID" target="_blank" rel="noopener noreferrer"
                  className="inline-flex items-center gap-1.5 hover:underline" style={{ fontSize: 14, color: BLUE }}>
                  <LineIcon /> 聯繫桃園門市Line官方
                </a>
              </div>

              <div className="flex flex-col sm:flex-row gap-3 w-full max-w-sm">
                <a href="https://maps.app.goo.gl/uvVyskPxRJMmDVsA8"
            ...
            <div className="relative w-full overflow-hidden rounded-2xl" style={{ aspectRatio: "4/3", minHeight: 320 }}>
              <iframe src={MAP_EMBED} title="Lunio 桃園門市地圖"
