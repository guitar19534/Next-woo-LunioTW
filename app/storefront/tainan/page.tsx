...
const MAP_EMBED = "https://maps.google.com/maps?q=台南市安平區文平路278號&output=embed&z=16&hl=zh-TW";
...
export default function TainanStorePage() {
  return (
    <main style={FONT}>
        ...
        <div className="max-w-[1200px] w-[88%] mx-auto">
          <div className="grid md:grid-cols-2 gap-10 md:gap-16 items-start">
            ...
            <div className="flex flex-col items-center text-center">
              ...
              <h1 className="font-bold mb-6" style={{ fontSize: "clamp(22px, 2.8vw, 36px)", color: NAVY }}>
                Dreamlands 精選名床｜台南旗艦店
              </h1>

              <div className="relative w-full overflow-hidden rounded-2xl mb-6" style={{ aspectRatio: "4/3", maxWidth: 480 }}>
                <Image src="/storefront/DreamLands-store.jpg" alt="Dreamlands 台南旗艦店" fill className="object-cover" sizes="(max-width:768px) 100vw, 480px" priority />
              </div>

              <div className="space-y-2 mb-6">
                <p style={{ fontSize: 15, color: NAVY, fontWeight: 500 }}>台南市安平區文平路278號</p>
                <p className="mt-3" style={{ fontSize: 14, color: "#444" }}>營業時間：每日 11:00 — 20:00</p>
                <a href="tel:+886937968070" className="block hover:underline font-medium" style={{ fontSize: 15, color: BLUE }}>
                  聯絡電話：+886 937 968 070
                </a>
                <a href="https://lin.ee/DOY6c8O" target="_blank" rel="noopener noreferrer"
                  className="inline-flex items-center gap-1.5 hover:underline" style={{ fontSize: 14, color: BLUE }}>
                  <LineIcon /> 聯繫台南門市Line官方
                </a>
              </div>

              <div className="flex flex-col sm:flex-row gap-3 w-full max-w-sm">
                <a href="https://maps.app.goo.gl/KxKMyZm9tNBDFmkg9"
            ...
            <div className="relative w-full overflow-hidden rounded-2xl" style={{ aspectRatio: "4/3", minHeight: 320 }}>
              <iframe src={MAP_EMBED} title="Dreamlands 台南旗艦店地圖"
                width="100%" height="100%" className="absolute inset-0 w-full h-full"
                style={{ border: "none" }} loading="lazy" referrerPolicy="no-referrer-when-downgrade" />
            </div>
