...
const MAP_EMBED = "https://maps.google.com/maps?q=台中市北屯區文心路三段405號&output=embed&z=16&hl=zh-TW";
...
export default function TaichungStorePage() {
  return (
    <main style={FONT}>
          ...
          <div className="grid md:grid-cols-2 gap-10 md:gap-16 items-start">
            ...
            <div className="flex flex-col items-center text-center">
              ...
              <div className="relative w-full overflow-hidden rounded-2xl mb-6" style={{ aspectRatio: "4/3", maxWidth: 480 }}>
                <Image src="/storefront/Taichung-store.jpg" alt="Lunio 台中門市" fill className="object-cover" sizes="(max-width:768px) 100vw, 480px" priority />
              </div>

              <div className="space-y-2 mb-6">
                <p style={{ fontSize: 15, color: NAVY, fontWeight: 500 }}>台中市北屯區文心路三段405號</p>
                <p style={{ fontSize: 14, color: "#6b7280" }}>（捷運文心中清站，城市停車場對面）</p>
            ...
            <div className="relative w-full overflow-hidden rounded-2xl" style={{ aspectRatio: "4/3", minHeight: 320 }}>
              <iframe src={MAP_EMBED} title="Lunio 台中門市地圖"
