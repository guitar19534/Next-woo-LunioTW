...
export const metadata: Metadata = {
  title: "雙人床墊推薦｜5尺、6尺、7尺雙人床墊｜Lunio Taiwan",
  description:
    "Lunio雙人床墊採用台灣規格，含5尺標準雙人、6尺加大、7尺特大。乳膠床墊、獨立筒、冷凝記憶床墊多種選擇，不論躺感、支撐度、涼感度，總有一款適合你！",
  alternates: { canonical: "/double-mattress" },
};
...
const PRODUCTS = [
  ...
  { src: "/mattress/nooz-topper-smartrest_04.jpg", badge: "最輕薄實惠", title: "Nooz SmartRest 翻轉床墊", size: "標準雙人(5尺)", original: "NT$7,225", price: "NT$2,890", feel: "中等", reason: "軟硬雙面任選，升級舊床墊，外宿租屋都合適。", support: 25, cool: 50, btnLabel: "了解 Nooz SmartRest", href: "/product/nooz-helix" },
];
...
export default function DoubleMattressPage() {
  return (
      ...
      <section style={{ background: "#fff", padding: "clamp(40px,5vw,64px) 0 clamp(32px,4vw,48px)" }}>
        <div style={W}>
          ...
          <p style={{ fontSize: "clamp(14px,1.1vw,16px)", color: "#444", marginBottom: 12, lineHeight: 1.8 }}>
            Lunio的雙人床墊採用台灣規格，雙人床墊尺寸如下：
          </p>
          <ul style={{ paddingLeft: 20, marginBottom: 20, lineHeight: 2.1, fontSize: "clamp(13px,1.05vw,15px)", color: "#444" }}>
            <li>5 尺床墊｜標準雙人：150 x 188 公分</li>
            <li>6 尺床墊｜雙人加大（Queen Size）：180 x 188 公分</li>
            <li>7 尺床墊｜雙人特大（King Size）：180 x 210 公分</li>
          </ul>
          <p style={{ fontSize: "clamp(13px,1.05vw,15px)", color: "#444", lineHeight: 1.9 }}>
            包含乳膠床墊、獨立筒床墊、冷凝記憶床墊、薄墊等多種材質款式，並不定期提供各種雙人床墊優惠。不論你喜歡哪種床墊躺感、支撐度、涼感度，總有一款適合你！
          </p>
        </div>
      </section>
        ...
        <div style={W}>
          <div className="grid grid-cols-1 md:grid-cols-2 gap-10 md:gap-16 items-center">
            ...
            <div style={{ position: "relative", width: "100%", paddingBottom: "56%", borderRadius: 16, overflow: "hidden" }}>
              <Image
                src="/double-mattress/雙人床尺寸-1.jpg"
                alt="Lunio台規雙人床尺寸挑選指南"
                fill
            ...
            <div>
              ...
              <div style={{ lineHeight: 2.1, fontSize: "clamp(13px,1.05vw,15px)", color: "#3a3a3a", marginBottom: 20 }}>
                <p>標準雙人床：150 x 188 公分/ 5 x 6.2 台尺</p>
                <p>加大雙人床：180 x 188 公分/ 6 x 6.2 台尺</p>
                <p>特大雙人床：180 x 210 公分/ 6 x 7 台尺</p>
              ...
              <p style={{ fontSize: "clamp(13px,1.05vw,15px)", color: "#444", lineHeight: 1.8 }}>
                若您需要尺寸選購上的建議，可先參考：{" "}
                <Link
                  href="/blog/full-size-bed/#elementor-toc__heading-anchor-8"
