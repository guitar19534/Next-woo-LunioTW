...
const PRODUCTS = [
  ...
  { src: "/mattress/Nooz-Trifold-Topper_cover-1.jpg", badge: "最萬用",    title: "Nooz Trifold 三折疊日式床墊",        size: "標準單人(3尺)", original: "NT$8,970", price: "NT$2,990", feel: "中等", reason: "好收好帶，一墊多用，居家外宿都方便。",               support: 30,  cool: 50, btnLabel: "了解 Nooz Trifold",     href: "/product/nooz-helix" },
