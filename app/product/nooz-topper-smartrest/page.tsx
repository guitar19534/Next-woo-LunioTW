...
export const metadata: Metadata = {
  ...
  description: "Nooz SmartRest Flip Topper 翻轉床墊。厚5公分，雙面翻轉軟硬任選，改善舊床舒適度。可水洗透氣床套，全台本島免運。",
      ...
      <section className="pt-12 pb-20" style={{ backgroundColor: "#f4f4f4" }}>
        <div className="max-w-[1400px] w-[85%] mx-auto">
          ...
          <div className="lg:hidden mb-4 space-y-2">
            ...
            <p style={{ fontSize: 14, color: "#aaa" }}>Nooz SmartRest Flip Topper</p>
            <h1 className="font-bold" style={{ fontSize: 26, color: "#17284b" }}>翻轉床墊（厚5公分）</h1>
