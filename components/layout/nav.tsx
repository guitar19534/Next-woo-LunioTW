 ...
 *   Mobile   [Hamburger]  [Logo — centered]  [Cart]
 */
...
import { NavScrollEffect } from "@/components/nav/nav-scroll-effect";
          ...
          <div className="grid grid-cols-[1fr_auto_1fr] items-center h-[70px] lg:hidden">
            ...
            >
              <Image
                ...
                className={cn("transition-all duration-300", !dark && "brightness-0")}
              />
            </Link>
