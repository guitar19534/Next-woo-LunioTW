...
const SLIDES = [
  { img: "/nebula/PC_1-2.webp",  imgMobile: "/nebula/Mobile_1-2.webp" },
  { img: "/nebula/PC_2-1.webp",  imgMobile: "/nebula/Mobile_2-2.webp" },
  { img: "/nebula/PC_3-2.webp",  imgMobile: "/nebula/Mobile_3-2.webp" },
];

export function NebulaLifestyleSlider() {
  ...
  return (
    <section className="bg-white py-10 md:py-14 overflow-hidden">
      ...
      {/* Mobile slider — 800×917 */}
      <div className="md:hidden w-[85%] mx-auto">
        <div className="relative w-full overflow-hidden rounded-2xl" style={{ aspectRatio: "800 / 917" }}>
          {SLIDES.map((s, i) => (
            <div key={i} className="absolute inset-0 transition-opacity duration-700"
              style={{ opacity: i === current ? 1 : 0 }}>
