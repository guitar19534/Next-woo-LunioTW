...
const SLEEP_POSITIONS = [
  { label: "仰睡", img: "/butterfly/Group-346.webp" },
  { label: "趴睡", img: "/butterfly/Group-347.webp" },
  { label: "側睡", img: "/butterfly/Group-348.webp" },
];
    ...
    <div style={{ backgroundColor: "#0f1b2d", ...FONT }}>
      ...
      <section className="py-14 md:py-20">
        <div className="max-w-[1200px] w-[90%] mx-auto">
          ...
          <p className="mb-4" style={{ fontSize: 14, color: "rgba(255,255,255,0.5)" }}>適合對象</p>
        ...
        <div className="max-w-[1200px] w-[90%] mx-auto">
          ...
          <div className="space-y-12">
            ...
            <div className="grid md:grid-cols-2 gap-8 items-center">
              <div>
                <p className="font-bold mb-4" style={{ fontSize: "clamp(15px, 1.5vw, 19px)", color: "#fff" }}>Nooz Ergo Butterfly</p>
                <ul className="space-y-2.5">
                  {BUTTERFLY_PROS.map((p) => (
              ...
              <div className="relative w-full" style={{ aspectRatio: "4/3" }}>
                <Image src="/butterfly/Lunio-Latex.webp" alt="Nooz Ergo Butterfly" fill className="object-contain" sizes="50vw" />
              </div>
            </div>
            {/* VS */}
            ...
            <div className="grid md:grid-cols-2 gap-8 items-center">
              ...
              <div className="relative w-full" style={{ aspectRatio: "4/3" }}>
                <Image src="/butterfly/Other-Compare (1).webp" alt="一般枕頭" fill className="object-contain" sizes="50vw" />
              </div>
            </div>
          </div>
        </div>
