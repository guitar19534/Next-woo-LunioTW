...
const VIDEO_ID = "PLACEHOLDER_EMBRACE_VIDEO";

export function EmbraceVideoSection() {
    ...
    <section className="py-14 md:py-20" style={{ backgroundColor: "#0a0a0a" }}>
      <div className="max-w-[1000px] w-[90%] mx-auto">
        <div className="text-center mb-10">
          <p className="font-bold" style={{ fontSize: "clamp(18px, 2.2vw, 28px)", color: "#fff", letterSpacing: "0.15em" }}>
            智能好眠系列
          </p>
          <p style={{ fontSize: "clamp(13px, 1.3vw, 16px)", color: "rgba(255,255,255,0.5)", marginTop: 6, letterSpacing: "0.2em" }}>
            享受智慧寢具 全面升級睡眠
          </p>
        </div>
          ...
          <div className="relative overflow-hidden rounded-2xl cursor-pointer"
            ...
            {playing ? (
              <iframe src={`https://www.youtube-nocookie.com/embed/${VIDEO_ID}?autoplay=1&rel=0`}
                title="Embrace video" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture"
              ...
              <>
                ...
                <img src={`https://img.youtube.com/vi/${VIDEO_ID}/maxresdefault.jpg`} alt="video thumbnail" className="absolute inset-0 w-full h-full object-cover" />
