...
const SIZES = [
  { label: "標準單人", dim: "91×188×35 CM" },
  { label: "單人加大", dim: "106×188×35 CM" },
  { label: "標準雙人", dim: "152×188×35 CM" },
  { label: "雙人加大", dim: "182×188×35 CM" },
  { label: "雙人特大", dim: "182×212×35 CM" },
];
...
const ACCORDION_ITEMS = [
  {
    ...
    content: (
      <div style={{ fontSize: 14, color: "#374151", lineHeight: 1.85 }}>
        <p className="font-bold mb-3" style={{ color: NAVY }}>天絲親膚 × 靜音防水｜真正好睡的保潔墊</p>
        <p className="mb-3" style={{ color: "#6b7280" }}>
          把防水做到安靜，是睡眠的基本尊重<br />
          粗糙的布料，或防水膜細碎的摩擦聲<br />
          常在你不自覺時，悄悄打斷睡眠的安穩<br /><br />
          Smartguard 防水保潔墊，將舒適與防護合而為一
        </p>
        <ul className="space-y-2" style={{ paddingLeft: "1.2em", listStyleType: "disc" }}>
          <li>100% 奧地利 TENCEL 天絲，天然涼感親膚，適合敏感肌</li>
          <li>TPU 超薄防水膜，100% 防水，卻輕薄安靜、零噪音</li>
          <li>床包設計，360° 高彈力鬆緊帶，彈性包覆，床面整齊漂亮</li>
          <li>OEKO-TEX® 認證，嬰幼兒、敏感肌也能安心用</li>
          <li>適用最高 30公分 床墊，可機洗、易保養，耐用不變形</li>
        </ul>
      </div>
    ),
  },
      ...
      <div style={{ fontSize: 14, color: "#374151" }}>
        <div className="grid md:grid-cols-2 gap-6 items-start">
          <ul className="space-y-3" style={{ paddingLeft: "1.2em", listStyleType: "disc", lineHeight: 1.85 }}>
            {SIZES.map((s) => (
              <li key={s.label}>
                <span className="font-medium" style={{ color: NAVY }}>{s.label}：</span>
                <br />{s.dim}
              </li>
            ))}
          </ul>
          <div className="relative w-full" style={{ aspectRatio: "4/3" }}>
            <Image src="/smartguard/SmartGuard.webp" alt="Lunio Smartguard 包裝" fill className="object-contain" sizes="200px" />
          </div>
        </div>
      </div>
    ),
  ...
  },
  {
    ...
    content: (
      <ul className="space-y-2.5" style={{ fontSize: 14, color: "#374151", paddingLeft: "1.2em", listStyleType: "disc", lineHeight: 1.85 }}>
        <li><strong>表布</strong>：100% 天絲萊賽爾</li>
        <li><strong>邊布</strong>：100% 滌綸</li>
        <li><strong>塗層</strong>：TPU 薄膜防水層</li>
      </ul>
    ),
  },
  {
    ...
    content: (
      <ul className="space-y-2" style={{ fontSize: 14, color: "#374151", paddingLeft: "1.2em", listStyleType: "disc", lineHeight: 1.85 }}>
        <li>請翻面放入洗衣袋，使用 40°C 以下冷水，低速柔洗</li>
        <li>不可漂白、浸泡、高速脫水</li>
        <li>於陰涼處懸掛晾乾；不可烘乾、熨燙或乾洗</li>
        <li>防水材質約可機洗 40 次，清洗頻率依髒污程度而定</li>
      </ul>
    ),
  },
];
...
export function SmartguardPanel({ product, variations }: Props) {
  ...
  return (
    <div className="space-y-6">
      <div className="hidden lg:block space-y-4">
        ...
        <div>
          <p style={{ fontSize: 16, color: "#9ca3af" }}>Lunio Smartguard</p>
          <h1 className="font-bold leading-tight" style={{ fontSize: 30, color: NAVY }}>智能防水保潔墊</h1>
        </div>
      ...
      <StickyCartBar productName="Lunio Smartguard" subtitle="智能防水保潔墊"
