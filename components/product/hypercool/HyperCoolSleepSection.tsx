...
const SLEEP_POSITIONS = [
  { label: "仰睡", img: "/hypercool/Group-346.webp" },
  { label: "趴睡", img: "/hypercool/Group-347.webp" },
  { label: "側睡", img: "/hypercool/Group-348.webp" },
];
...
export function HyperCoolSleepSection() {
  return (
    <div style={{ backgroundColor: "#0f1b2d", fontFamily: "'MiSansTC','Noto Sans TC',sans-serif" }}>
        ...
        <div className="max-w-[1200px] w-[90%] mx-auto">
          ...
          <div className="space-y-12">
            ...
            <div className="grid md:grid-cols-2 gap-8 items-center">
              <div>
                <p className="font-bold mb-4" style={{ fontSize: "clamp(15px, 1.5vw, 19px)", color: "#fff" }}>HyperCool 智能工學護頸枕</p>
                <ul className="space-y-2.5">
                  {HYPERCOOL_PROS.map((p) => (
              ...
              <div className="relative w-full" style={{ aspectRatio: "4/3" }}>
                <Image src="/hypercool/Hypercool-no-bg.webp" alt="HyperCool 護頸枕" fill className="object-contain" sizes="50vw" />
              </div>
            </div>
            ...
            <div className="grid md:grid-cols-2 gap-8 items-center">
              ...
              <div className="relative w-full" style={{ aspectRatio: "4/3" }}>
                <Image src="/hypercool/Other-Compare (1).webp" alt="一般枕頭" fill className="object-contain" sizes="50vw" />
              </div>
            </div>
          </div>
        </div>
