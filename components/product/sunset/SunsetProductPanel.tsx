...
const SESSION_KEY = "lunio_sunset_countdown_end";
...
function CountdownBlock() {
  ...
  return (
    <div className="overflow-hidden rounded-2xl" style={{ backgroundColor: "#FEF3E7" }}>
      {/* Orange header */}
      <div
        className="flex items-center justify-center gap-2 py-2.5"
        style={{ background: "linear-gradient(90deg, #E07B2E, #F5A623)", borderRadius: "16px 16px 0 0" }}
      >
...
export function SunsetProductPanel({ product, variations }: Props) {
  ...
  return (
    <div className="space-y-5">
      ...
      <div className="hidden lg:block space-y-5">
        ...
        <div>
          <h1 className="leading-tight mb-1" style={{ fontSize: "30px", color: "#E07B2E", fontWeight: 600 }}>
            NOOZ Sunset Pro乳膠床墊
          </h1>
        </div>
      ...
      <div className="space-y-2" style={{ fontSize: "15px", color: "#333", lineHeight: 1.85 }}>
        <p className="font-bold" style={{ color: "#17284b" }}>想睡硬床？找我就對了</p>
        <p>長輩安心、腰背舒適</p>
        <p>Sunset Pro 乳膠床墊，專為喜歡硬床的你設計</p>
        <p>100%天然乳膠 + 活性碳支撐層</p>
        <p>加強腰部支撐，釋放腰背壓力</p>
        <p>每一次翻身都輕鬆流暢</p>
        <p>厚實有彈性，胖瘦都能穩穩支撐</p>
        <p>中等偏硬的躺感，讓你一躺下就安心</p>
      </div>

      {/* Promo box */}
      <div className="rounded-2xl p-5" style={{ backgroundColor: "#FEF3E7" }}>
      ...
      <div className="flex items-baseline gap-3">
        <span className="font-bold" style={{ fontSize: "26px", color: "#E07B2E" }}>
      ...
      {variations.length > 0 && (
        <div className="flex items-center gap-3">
          ...
          <select
            ...
            style={{ borderColor: "#ddd", color: "#17284b", backgroundColor: "#E07B2E1a" }}
            onChange={(e) => {
      ...
      <div className="flex items-center gap-3">
        ...
        <button
          ...
          style={{ backgroundColor: "#E07B2E", fontSize: "16px", letterSpacing: "0.05em" }}
        >
          {adding ? "加入中..." : "立刻搶購"}
        </button>
      </div>
