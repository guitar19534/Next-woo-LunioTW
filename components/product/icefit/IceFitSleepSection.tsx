...
const SLEEP_POSITIONS = [
  { label: "仰睡", img: "/smartcurve/Group-346.webp" },
  { label: "趴睡", img: "/smartcurve/Group-347.webp" },
  { label: "側睡", img: "/smartcurve/Group-348.webp" },
];
...
export function IceFitSleepSection() {
  return (
        ...
        <div className="max-w-[1200px] w-[90%] mx-auto">
          ...
          <div className="space-y-12">
            <div className="grid md:grid-cols-2 gap-8 items-center">
              <div>
                <p className="font-bold mb-4" style={{ fontSize: "clamp(14px, 1.4vw, 17px)", color: "#fff" }}>Lunio IceFit Smart Curve 智能涼感護頸枕</p>
              ...
              <div className="relative w-full" style={{ aspectRatio: "4/3" }}>
                <Image src="/smartcurve/Smartcurve_Product-Description-1.webp" alt="IceFit Smart Curve" fill className="object-contain" sizes="50vw" />
              </div>
            </div>
            ...
            <div className="grid md:grid-cols-2 gap-8 items-center">
              ...
              <div className="relative w-full" style={{ aspectRatio: "4/3" }}>
                <Image src="/smartcurve/Other-Compare (1).webp" alt="一般枕頭" fill className="object-contain" sizes="50vw" />
              </div>
            </div>
          </div>
        </div>
