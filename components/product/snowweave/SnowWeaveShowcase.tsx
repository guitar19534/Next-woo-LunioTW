...
const FEATURES: Feature[] = [
  {
    type: "image",
    imageSrc: "/snowweave/Benefit1.webp",
    imageAlt: "Lunio SnowWeave Benefit 1",
    title: "360° 高彈力鬆緊帶床包 鋪床更服貼",
    desc: "無論床墊厚薄都能完整包覆\n讓床面始終平整漂亮\n整理床鋪變得輕鬆優雅 ",
  },
  {
    type: "video",
    videoSrc: "/snowweave/Benefit2.mp4",
    poster: "",
    title: "100% 天絲萊賽爾纖維 親膚乾爽",
    desc: "天然纖維柔滑貼膚且排汗快乾，\n讓深夜的翻身依舊維持清爽，\n讓肌膚徹底放鬆 ",
  },
  {
    type: "video",
    videoSrc: "/snowweave/Benefit3.mp4",
    poster: "",
    title: "115gsm 高規格厚度，耐洗耐用",
    desc: "紮實布料耐用不易撕裂，\n長時間使用仍保有彈性與舒適感",
  },
  {
    type: "image",
    imageSrc: "/snowweave/Benefit4.webp",
    imageAlt: "Lunio SnowWeave Benefit 4",
    title: "60 支紗 × 300 織細膩柔軟",
    desc: "高密度織法帶來絲滑觸感與細緻手感 \n每一次接觸都是溫柔的享受",
  },
];
...
function SnowWeaveVideoSection() {
...
export function SnowWeaveFeatures() {
...
export function SnowWeavePricing() {
  const first = SIZES[0];
    ...
    <div className="bg-[#F8F8F8] pt-4 pb-16 md:pt-6 md:pb-24">
      <div className="max-w-[1140px] mx-auto px-5 sm:px-8 text-center">
        ...
        <div className="mb-12 -mx-5 sm:-mx-8">
          <Image
            src="/snowweave/SnowWeave-Cartoon.webp"
            alt="Lunio SnowWeave 智能天絲被套"
            width={1400}
            height={1000}
...
export function SnowWeaveShowcase() {
  return (
    <>
      <SnowWeaveIntro />
      <SnowWeaveVideoSection />
    </>
  );
}
