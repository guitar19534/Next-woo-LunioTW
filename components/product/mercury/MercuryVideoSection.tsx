...
const VIDEO_ID = "PLACEHOLDER_MERCURY_VIDEO";

export function MercuryVideoSection() {
          ...
          <div className="relative overflow-hidden rounded-2xl cursor-pointer"
            ...
            {playing ? (
              <iframe src={`https://www.youtube-nocookie.com/embed/${VIDEO_ID}?autoplay=1&rel=0`}
                title="Mercury video" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture"
