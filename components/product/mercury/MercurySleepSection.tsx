...
const SLEEP_POSITIONS = [
  { label: "仰睡", img: "/mercury/Group-346.webp" },
  { label: "趴睡", img: "/mercury/Group-347.webp" },
  { label: "側睡", img: "/mercury/Group-348.webp" },
];
...
export function MercurySleepSection() {
  return (
        ...
        <div className="max-w-[1200px] w-[90%] mx-auto">
          ...
          <div className="space-y-12">
            ...
            <div className="grid md:grid-cols-2 gap-8 items-center">
              <div>
                <p className="font-bold mb-4" style={{ fontSize: "clamp(15px, 1.5vw, 19px)", color: "#fff" }}>Mercury 石墨烯機能記憶枕</p>
              ...
              <div className="relative w-full" style={{ aspectRatio: "4/3" }}>
                <Image src="/mercury/Murcury1.webp" alt="Mercury 石墨烯機能記憶枕" fill className="object-contain" sizes="50vw" />
              </div>
            </div>
            {/* VS */}
            ...
            <div className="grid md:grid-cols-2 gap-8 items-center">
              ...
              <div className="relative w-full" style={{ aspectRatio: "4/3" }}>
                <Image src="/mercury/Other-Compare.webp" alt="一般枕頭" fill className="object-contain" sizes="50vw" />
              </div>
            </div>
          </div>
        </div>
