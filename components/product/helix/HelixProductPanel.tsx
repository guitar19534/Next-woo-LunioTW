...
const VARIATION_LABELS: Record<string, string> = {
  ...
  "雙人加大":              "【雙人加大】現折13,080",
  "雙人特大":              "【雙人特大】現折14,280",
  "標準單人+記憶枕買1送1": "【標準單人】＋記憶枕買1送1 現折13,540",
  "單人加大+記憶枕買1送1": "【單人加大】＋記憶枕買1送1 現折15,860",
  "標準雙人+記憶枕買1送1": "【標準雙人】＋記憶枕買1送1 現折18,260",
  "雙人加大+記憶枕買1送1": "【雙人加大】＋記憶枕買1送1 現折20,000",
  "雙人特大+記憶枕買1送1": "【雙人特大】＋記憶枕買1送1 現折20,660",
};

// ── Countdown — 12-hour autoloop ─────────────────────────────────────────────
const SESSION_KEY = "lunio_helix_countdown_end";
...
function CountdownBlock() {
  ...
  return (
    <div className="overflow-hidden rounded-2xl" style={{ backgroundColor: "#e8eaf6" }}>
      {/* Green header */}
      <div
        className="flex items-center justify-center gap-2 py-2.5"
        style={{ background: "linear-gradient(90deg, #00b894, #00cec9)", borderRadius: "16px 16px 0 0" }}
      >
...
export function HelixProductPanel({ product, variations }: Props) {
  ...
  return (
    <div className="space-y-5">
      ...
      <div className="hidden lg:block space-y-5">
        ...
        <div>
          <h1 className="leading-tight mb-1" style={{ fontSize: "30px", color: "#17284b", fontWeight: 600 }}>
            NOOZ Helix 乳膠獨立筒床墊
          </h1>
        </div>
      ...
      <div className="space-y-2" style={{ fontSize: "15px", color: "#333", lineHeight: 1.85 }}>
        <p className="font-bold" style={{ color: "#17284b" }}>躺下，就像在五星飯店度假</p>
        <p>床墊服貼身體曲線，溫柔釋放一整天的壓力</p>
        <p>5區支撐設計，貼合身體各部位</p>
        <p>柔軟中帶著彈性，彷彿躺在蓬鬆的枕頭山，完全放鬆</p>
        <p>搭配歐洲頂級毛氈表層，細緻柔軟、蓬鬆奢華</p>
        <p>每個夜晚，都像在五星飯店度假</p>
      </div>

      {/* Promo box */}
      <div className="rounded-2xl p-5" style={{ backgroundColor: "#58595B2E" }}>
        ...
        <ul className="space-y-3">
          ...
          <li className="text-sm" style={{ lineHeight: 1.7 }}>
            🎁 好康二：
            {/* TODO: 換成加購頁面連結 */}
            <a href="#" style={{ color: "#17569E", fontWeight: 500 }}>
