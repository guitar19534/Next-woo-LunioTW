...
export function Hero() {
  ...
  return (
    <section
      className="relative min-h-[55vh] md:min-h-[110vh] flex items-center overflow-hidden bg-[#17284b]"
    ...
    >
      ...
      {/* ── Content ──────────────────────────────────────────────────────── */}
      <div className="relative z-10 w-full max-w-[1140px] mx-auto px-5 sm:px-8 py-10 md:py-40 text-white text-center">
        <h1
