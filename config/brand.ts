...
export const brandConfig = {
  // ─── Logo ────────────────────────────────────────────────────────────────────
  logo: {
    src: "/brand/logo.svg",   // ← Replace with your actual logo
    width: 120,               // SVG native: 300pt × 136pt (2.206:1 ratio)
    height: 55,
    alt: "Lunio",
  },
  ...
  hero: {
    ...
    title: "為了更好的\n睡眠品質",
    subtitle:
      "石墨烯乳膠技術 × 骨科醫師聯合研發 × 100 晚免費試睡保證",
    ctaPrimary: { label: "立即選購", href: "/shop" },
